...
function UltrasLeagueAdminComponent() {
    ...
    useEffect(()=>{
        fetch(process.env.REACT_APP_API+'/ultrasleague/leagues',{
            credentials:'include'
        }).then(res=>{
    ...
    async function addNewLeague(ev) {
        try{
            if( !(name)){
                ...
                ev.preventDefault();
                const res= await fetch(process.env.REACT_APP_API+'/ultrasleague/leagues',{
                    method:'POST',
    ...
    async function deleteLeague(id){
        ...
        const delresponse = await fetch(process.env.REACT_APP_API+'/ultrasleague/leagues/'+id, {
          method: 'DELETE',
          credentials: 'include',
        });
        if(delresponse){
